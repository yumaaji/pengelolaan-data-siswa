<div class="sidebar-wrapper active">
  ...
  <div class="sidebar-menu">
    <ul class="menu">
      ...
      <li class="sidebar-item has-sub <?= (strpos($current_url, 'dataguru') !== false || strpos($current_url, 'datasiswa') !== false || strpos($current_url, 'datakelas') !== false) ? 'active' : ''  ?>">
        ...
        <ul class="submenu">
          <li class="submenu-item">
            <a href="/dashboard/dataguru" class="submenu-link">Guru</a>
          </li>
          <li class="submenu-item">
            <a href="/dashboard/datasiswa" class="submenu-link">Siswa</a>
          </li>
          <li class="submenu-item">
            <a href="/dashboard/datakelas" class="submenu-link">Kelas</a>
          </li>
        </ul>
      </li>
    </ul>
